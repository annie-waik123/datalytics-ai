...
export const SECTION_ITEMS = [
  { key: 'shape',         label: 'Dataset Shape',        description: 'Total rows and columns' },
  { key: 'preview',       label: 'Dataset Preview',       description: 'Head and Tail data' },
  { key: 'info',          label: 'Dataset Info',          description: 'Data types and schema' },
  { key: 'missing',       label: 'Missing Values',        description: 'Null check and counts' },
  { key: 'stats',         label: 'Statistical Summary',   description: 'Descriptive statistics' },
  { key: 'distribution',  label: 'Data Distribution',     description: 'Histograms and distributions' },
  { key: 'categorical',   label: 'Categorical Analysis',  description: 'Counts and frequencies' },
  { key: 'outliers',      label: 'Outlier Detection',     description: 'Extreme values tracking' },
  { key: 'relationships', label: 'Relationship Analysis', description: 'Correlations and pairs' },
]
