...
export default function DashboardChartLibrary({
  ...
  if (collapsed) {
    return (
      <aside style={{ display: 'flex', flexDirection: 'column', width: 52, minWidth: 52, alignItems: 'center', padding: '12px 0', gap: 12, background: 'rgba(21,25,37,0.85)', borderRight: '1px solid rgba(148,190,255,0.05)', borderTopRightRadius: 16, height: '100%', boxSizing: 'border-box' }}>
        <button
          type="button"
          onClick={onToggleCollapsed}
          style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', borderRadius: '50%', width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', paddingBottom: 2 }}
  ...
  return (
    <aside className="builder-sidebar builder-sidebar-left">
      <div className="builder-panel-header">
        <div>
          <h3>Builder Panel</h3>
          <p>Switch between visuals, fields, filters, and AI-guided insight actions.</p>
        </div>
        <button type="button" className="builder-panel-toggle" onClick={onToggleCollapsed} aria-label="Collapse visuals panel">
          {'<'}
        </button>
      </div>
