    ...
    if not st.session_state.supervised_done:
        st.markdown(
            ...
            <div style="text-align: center; padding: 2rem; margin: 2rem 0;">
                <p style="font-size: 1.2rem; color: #FFA500; margin: 0;">
                    ⚠️ 🤖 <strong>Train supervised models first.</strong> 🚀
                </p>
                <p style="font-size: 1rem; color: #888; margin-top: 0.5rem;">
                    📊 Please go to the Model Training section and train your models before viewing the best model selection.
                </p>
            </div>
            """,
            unsafe_allow_html=True
