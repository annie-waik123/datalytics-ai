...
from app.services.analytics_service import dataset_signature, load_analysis_frame
from app.services.cache_service import cache
from app.services.data_engine_service import build_dataset_json_payload, has_live_dataset, restore_live_dataset
from app.services.ml_service import build_dataset_snapshot, explore_dataset
from app.services.dataset_service import page_dataset, store_dataframe_in_session
from app.services.dashboard_service import build_dashboard_metadata, render_dashboard_widget, suggest_dashboard_widget
...
async def visualization_geo(
    ...
    from app.services.geo_visualization_service import render_geo_map
    session = store.get(x_session_id)
    if session.df is None:
